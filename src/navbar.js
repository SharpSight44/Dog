...
<li className="nav-item">
  <a className="nav-link" href="https://www.instagram.com/mountdoodlesfam/?hl=en" target="_blank">
...
<li className="nav-item">
  <a className="nav-link" href="https://www.tiktok.com/@mountdoodlesfam" target="_blank">
  <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="black" className="bi bi-tiktok" viewBox="0 0 16 16">
